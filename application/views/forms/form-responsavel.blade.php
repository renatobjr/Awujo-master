                ...
                <div class="row">
                    ...
                    <div class="col s12 m12 l5 input-field">{{-- Raça --}}
                        ...
                        <select name="raca-responsavel" id="raca-responsavel">
                            ...
                            <option value="5" @if ( ! isset($method) && ($raca === '5')) {{ 'selected' }} @endif>Outra não especificada</option>
                        </select>
                        <label>Raça</label>
                    </div>
                    <div class="col s12 m12 l5 input-field">{{-- Escolaridade --}}
                        ...
                        <select name="escolaridade" id="escolaridade">
                            <option value="1" @if ( ! isset($method) && ($escolaridade === '1')) {{ 'selected' }} @endif>Sem Escolaridade</option>
                            <option value="2" @if ( ! isset($method) && ($escolaridade === '2')) {{ 'selected' }} @endif>Fundamental I</option>
                            <option value="3" @if ( ! isset($method) && ($escolaridade === '3')) {{ 'selected' }} @endif>Fundamental II</option>
                            <option value="4" @if ( ! isset($method) && ($escolaridade === '4')) {{ 'selected' }} @endif>Ensino Médio</option>
                            <option value="5" @if ( ! isset($method) && ($escolaridade === '5')) {{ 'selected' }} @endif>Ensino Superior</option>
                        </select>
                ...
                <div class="row">
                    <div class="col s12 m12 l5 input-field">{{-- Logradouro --}}
                        ...
                        <input type="text" name="logradouro" id="logradouro"
                               class="validate"
                               value="{!! isset($method) ? set_value('logradouro') : $rua !!}"
                               placeholder="">
                    ...
                    <div class="col s12 m12 l5 input-field">{{-- Bairro --}}
                        ...
                        <input type="text" name="bairro" id="bairro" class="validate"
                               value="{!! isset($method) ? set_value('bairro') : $idade !!}"
                               placeholder="">
                        ...
                        <p>
                            <label>
                                <input type="radio" name="pessoa-com-deficiencia" id="deficiente-sim" value="1"
                                    @if ( ! isset($method) && ($pessoa_deficiencia === '1')) {{ 'checked' }} @endif>
                                <span>Sim</span>
                            </label>
                        </p>
                        <p>
                            <label>
                                <input type="radio" name="pessoa-com-deficiencia" id="deficiente-nao" value="0"
                                    @if ( ! isset($method) && ($pessoa_deficiencia === '0')) {{ 'checked' }} @endif>
                                <span>Não</span>
                            </label>
                        </p>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col s12 m12 l3 input-field">
                        ...
                        <input type="text" name="renda-adultos" id="renda-adultos"
                               ...
                               value="{!! isset($method) ? set_value('renda-adultos') : $renda_adultos !!}"
                               placeholder="Valor em R$">
                    ...
                    <div class="col s12 m12 l3 offset-l3 input-field">
                        ...
                        <input readonly type="text" name="renda-total" id="renda-total"
                               class="real"
                               value="{!! isset($method) ? set_value('renda-total') : $renda_total !!}"
                               placeholder="Valor em R$">
                ...
                <div class="row">
                    <div class="col s12 m12 l4 input-field">
                        ...
                        <select name="programas-governo[]" size="6" id="programas-governo" multiple>
                            <option value="1" @if ( ! isset($method) && ($nenhum_programa === '1')) {{ 'selected' }} @endif>Nenhum</option>
                            <option value="2" @if ( ! isset($method) && ($bolsa_familia === '1')) {{ 'selected' }} @endif>Bolsa Família</option>
                            <option value="3" @if ( ! isset($method) && ($bpc === '1')) {{ 'selected' }} @endif>BPC</option>
                            <option value="4" @if ( ! isset($method) && ($aposentadoria === '1')) {{ 'selected' }} @endif>Aposentadoria</option>
                            <option value="5" @if ( ! isset($method) && ($pensao === '1')) {{ 'selected' }} @endif>Pensão</option>
                            <option value="6" @if ( ! isset($method) && ($beneficio_eventual === '1')) {{ 'selected' }} @endif>Benefício eventual</option>
                        </select>
