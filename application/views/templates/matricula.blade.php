...
<body class="container">
    ...
    <div class="row">
        <div class="col m3 l3">
            <p class="light"><b>Nome completo:</b> {{ $matricula['nome_beneficiario'] }}</p>
        </div>
        <div class="col m3 l3">
            <p class="light"><b>Nome do Responsável: </b><span class="">{{ $matricula['nome_responsavel'] }}</span></p>
        </div>
        <div class="col m3 l3">
            <p class="light"><b>CPF: </b><span class="cpf">{{ $matricula['cpf_beneficiario'] }}</span></p>
        </div>
        <div class="col m3 l3">
            <p class="light"><b>NIS: </b><span class="nis">{{ $matricula['nis_beneficiario'] }}</span></p>
        </div>
    </div>
    <div class="row">
        <div class="col m3 l2">
        ...
        <div class="col m2 l2">
            <p class="light"><b>Idade: </b>{{ $matricula['idade_beneficiario'] }} Anos</p>
        </div>
        <div class="col m3 l3">
        ...
        <div class="col m3 l3">
            <p class="light"><b>Projeto: </b>{{ $matricula['nome_projeto'] }}</p>
        </div>
        <div class="col m3 l2">
    ...
    <div class="row">
         <div class="col m12 l12">
             <p class="light"><b>Atividade: </b>{{ $matricula['atividades'] }}</p>       
         </div>           
    </div>
    <div class="divider"></div>
    <div class="row">
        <div class="col m12 l12">
            <p class="light">Cadastro realizado em {{ date('d/m/Y', strtotime($matricula['criado_em'])) }} às
                {{ date('H:i', strtotime($matricula['criado_em'])) }} por {{ $matricula['nome_completo'] }}</p>
        </div>
    </div>
