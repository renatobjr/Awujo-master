    ...
    <div class="hide-on-med-and-down">
        <nav class="grey lighten-5">
            <div class="nav-wrapper">
                <a href="{{ base_url('dashboard') }}" id="logo-container" class="brand-logo">
                    <img src="{{ base_url('resources/svg/awujo.logo.simple.svg') }}" alt="" class="responsive-img"
                         style="height: 5vh; padding-left: 4vh">
                </a>
                <ul>
                    <li class="right"><a href="{{ base_url('logout') }}"><i class="material-icons black-text">
                                logout</i></a></li>
                    <li class="right"><a class="black-text light" href="#">Olá {{ $_SESSION['nome-usuario'] }}</a></li>
                </ul>
            </div>
        </nav>
    </div>
    <div class="fixed-action-btn">{{-- fixedbtn --}}
        <a href="#" class="btn-floating btn-large indigo darken-4"><i class="material-icons">apps</i></a>
        <ul>
            @if($_SESSION['nome-usuario'] === 'Suporte')
            <li><a href="{{ base_url('dashboard/cadastrar-usuario') }}" class="btn-floating red darken-4">
                    <i class="material-icons">account_circle</i></a></li>
            @endif

            <li><a href="{{ base_url('dashboard/cadastrar-beneficiarios') }}" class="btn-floating yellow darken-4">
                    <i class="material-icons">face</i></a></li>
        
            <li><a href="{{ base_url('dashboard/cadastrar-responsavel') }}" class="btn-floating green darken-4">
                    <i class="material-icons">supervised_user_circle</i></a></li>

            <li><a href="{{ base_url('dashboard/cadastrar-projeto') }}" class="btn-floating blue darken-4">
                    <i class="material-icons">assignment</i></a></li>

            <li><a href="{{ base_url('dashboard') }}" class="btn-floating indigo darken-4">
...
<aside>{{-- Menu lateral --}}
    <ul id="slide-out" class="sidenav sidenav-fixed indigo darken-4">
        <li><a href="{{ base_url('dashboard') }}"><i class="material-icons white-text small valign-wrapper">home</i></a></li>
...
<ul id="menu-projetos" class="dropdown-content">
    ...
    <li><a href="{{ base_url('dashboard/lista-alunos') }}"><span class="light">Lista de Matrículas</span></a></li>
</ul>
<ul id="menu-alimentos" class="dropdown-content">
    <li><a href="#">SESC <span class="right">{{ $total_registros['total_nis'] }} Pessoas</span></a></li>
    <li><a href="{{ base_url('dashboard/imprimir-lista/sesc') }}" target="_blank"><span class="light">Lista de Contatos</span></a></li>
    <li class="divider"></li>
    <li><a href="#">PMJP <span class="right">{{ $total_registros['total'] }} Pessoas</span></a></li>
    <li><a href="{{ base_url('dashboard/imprimir-lista/pmjp') }}" target="_blank"><span class="light">Lista de Contatos</span></a></li>
</ul>
