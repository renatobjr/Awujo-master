        ...
        <div class="card white">
            <div class="card-content black-text">
                <span class="card-title light">
                    <?php echo isset($method) ? 'Cadastro do Responsável pela Família' : 'Edição de Cadastro'; ?>
            ...
            <?php else: ?>
                <?php echo form_open("dashboard/atualizar-responsavel"); ?>

                <?php echo '<input type="hidden" name="idresponsavel" id="idresponsavel" value="' . $idresponsavel . '">'; ?>
                ...
                <div class="row">
                    <div class="col s12 m12 l6 input-field">
                        ...
                        <input type="text" name="nome-responsavel" id="nome-responsavel"
                               ...
                               value="<?php echo isset($method) ? set_value('nome-responsavel') : $nome_responsavel; ?>">
                    ...
                    <div class="col s12 m12 l3 input-field">
                        ...
                        <input type="text" name="cpf-responsavel" id="cpf-responsavel"
                               ...
                               value="<?php echo isset($method) ? set_value('cpf-responsavel') : $cpf; ?>">
                    ...
                    <div class="col s12 m12 l3 input-field">
                        ...
                        <input type="text" name="nis-responsavel" id="nis-responsavel"
                               ...
                               value="<?php echo isset($method) ? set_value('nis-responsavel') : $nis; ?>">
                ...
                <div class="row">
                    <div class="col s12 m12 l2 input-field">
                        ...
                        <input type="text" name="idade-responsavel" id="idade-responsavel"
                               ...
                               value="<?php echo isset($method) ? set_value('idade-responsavel') : $idade; ?>">
                    ...
                    <div class="col s12 m12 l5 input-field">
                        ...
                        <select name="raca-responsavel" id="raca-responsavel">
                            <option value="1" <?php if( ! isset($method) && ($raca === '1')): ?> <?php echo e('selected'); ?> <?php endif; ?>>Negra</option>
                            <option value="2" <?php if( ! isset($method) && ($raca === '2')): ?> <?php echo e('selected'); ?> <?php endif; ?>>Branca</option>
                            <option value="3" <?php if( ! isset($method) && ($raca === '3')): ?> <?php echo e('selected'); ?> <?php endif; ?>>Parda</option>
                            <option value="4" <?php if( ! isset($method) && ($raca === '4')): ?> <?php echo e('selected'); ?> <?php endif; ?>>Indígena</option>
                            <option value="5" <?php if( ! isset($method) && ($raca === '5')): ?> <?php echo e('selected'); ?> <?php endif; ?>>Outra não especificada</option>
                        </select>
                        <label>Raça</label>
                    </div>
                    <div class="col s12 m12 l5 input-field">
                        ...
                        <select name="escolaridade" id="escolaridade">
                            <option value="1" <?php if( ! isset($method) && ($escolaridade === '1')): ?> <?php echo e('selected'); ?> <?php endif; ?>>Sem Escolaridade</option>
                            <option value="2" <?php if( ! isset($method) && ($escolaridade === '2')): ?> <?php echo e('selected'); ?> <?php endif; ?>>Fundamental I</option>
                            <option value="3" <?php if( ! isset($method) && ($escolaridade === '3')): ?> <?php echo e('selected'); ?> <?php endif; ?>>Fundamental II</option>
                            <option value="4" <?php if( ! isset($method) && ($escolaridade === '4')): ?> <?php echo e('selected'); ?> <?php endif; ?>>Ensino Médio</option>
                            <option value="5" <?php if( ! isset($method) && ($escolaridade === '5')): ?> <?php echo e('selected'); ?> <?php endif; ?>>Ensino Superior</option>
                        </select>
                ...
                <div class="row">
                    ...
                    <div class="col s12 m12 l3 input-field">
                        ...
                        <input type="text" name="telefone-fixo" id="telefone-fixo"
                               class="fone validate <?php if(form_error('telefone-fixo')): ?> <?php echo e('invalid'); ?> <?php endif; ?>"
                               value="<?php echo isset($method) ? set_value('telefone-fixo') : $telefone_fixo; ?>">
                        <label for="telefone-fixo">Telefone Fixo</label>
                        <span class="helper-text" data-error="<?php echo form_error('telefone-fixo'); ?>"></span>
                    </div>
                    <div class="col s12 m12 l3 input-field">
                        <i class="material-icons prefix">smartphone</i>
                        <input type="text" name="telefone-movel" id="telefone-movel"
                               class="movel validate <?php if(form_error('telefone-movel')): ?> <?php echo e('invalid'); ?> <?php endif; ?>"
                               value="<?php echo isset($method) ? set_value('telefone-movel') : $telefone_movel; ?>">
                        <label for="telefone-movel">Celular</label>
                        <span class="helper-text" data-error="<?php echo form_error('telefone-movel'); ?>"></span>
                    </div>
                    <div class="col s12 m12 l4 input-field">
                        <i class="material-icons prefix">person</i>
                        <input type="text" name="pessoa-contato" id="pessoa-contato"
                               value="<?php echo isset($method) ? set_value('pessoa-contato') : $pessoa_contato; ?>">
                ...
                <div class="row">
                    <div class="col s12 m12 l5 input-field">
                        ...
                        <input type="text" name="logradouro" id="logradouro"
                               class="validate"
                               value="<?php echo isset($method) ? set_value('logradouro') : $rua; ?>"
                               placeholder="">
                    ...
                    <div class="col s12 m12 l2 input-field">
                        ...
                        <input type="text" name="numero" id="numero"
                               ...
                               value="<?php echo isset($method) ? set_value('numero') : $numero; ?>">
                    ...
                    <div class="col s12 m12 l5 input-field">
                        ...
                        <input type="text" name="bairro" id="bairro" class="validate"
                               value="<?php echo isset($method) ? set_value('bairro') : $idade; ?>"
                               placeholder="">
                ...
                <div class="row">
                    <div class="col s12 m12 l3 input-field">
                        ...
                        <input type="text" name="criancas-ate-06" id="criancas-ate-06"
                               ...
                               value="<?php echo isset($method) ? set_value('criancas-ate-06') : $criancas_ate_06_anos; ?>">
                    ...
                    <div class="col s12 m12 l3 input-field">
                        ...
                        <input type="text" name="criancas-07-ate-17" id="criancas-07-ate-17"
                               ...
                               value="<?php echo isset($method) ? set_value('criancas-07-ate-17') : $criancas_entre_07_17_anos; ?>">
                    ...
                    <div class="col s12 m12 l3 input-field">
                        ...
                        <input type="text" name="adultos" id="adultos"
                               ...
                               value="<?php echo isset($method) ? set_value('adultos') : $adultos; ?>">
                    ...
                    <div class="col s12 m12 l3 input-field">
                        ...
                        <input type="text" name="idosos" id="idosos"
                               ...
                               value="<?php echo isset($method) ? set_value('idosos') : $idosos; ?>">
                ...
                <div class="row">
                        ...
                        <p>
                            <label>
                                <input type="radio" name="pessoa-com-deficiencia" id="deficiente-sim" value="1"
                                    <?php if( ! isset($method) && ($pessoa_deficiencia === '1')): ?> <?php echo e('checked'); ?> <?php endif; ?>>
                                <span>Sim</span>
                            </label>
                        </p>
                        <p>
                            <label>
                                <input type="radio" name="pessoa-com-deficiencia" id="deficiente-nao" value="0"
                                    <?php if( ! isset($method) && ($pessoa_deficiencia === '0')): ?> <?php echo e('checked'); ?> <?php endif; ?>>
                                <span>Não</span>
                            </label>
                        </p>
                    </div>
                    <div class="col s12 m12 l4 input-field">
                        ...
                        <input type="text" name="tipo-deficiencia" id="tipo-deficiencia" class="validate"
                               value="<?php echo isset($method) ? set_value('tipo-deficiencia') : $tipo_deficiencia; ?>">
                    ...
                    <div class="col s12 m12 l5 input-field">
                        ...
                        <input type="text" name="nome-deficiente" id="nome-deficiente" class="validate"
                               value="<?php echo isset($method) ? set_value('nome-deficiente') : $nome_deficiente; ?>">
                ...
                <div class="row">
                    <div class="col s12 m12 l3 input-field">
                        ...
                        <input type="text" name="renda-responsavel" id="renda-responsavel"
                               ...
                               value="<?php echo isset($method) ? set_value('renda-responsavel') : $renda_responsavel; ?>"
                    ...
                    <div class="col s12 m12 l3 input-field">
                        ...
                        <input type="text" name="renda-adultos" id="renda-adultos"
                               ...
                               value="<?php echo isset($method) ? set_value('renda-adultos') : $renda_adultos; ?>"
                               placeholder="Valor em R$">
                    ...
                    <div class="col s12 m12 l3 offset-l3 input-field">
                        ...
                        <input readonly type="text" name="renda-total" id="renda-total"
                               class="real"
                               value="<?php echo isset($method) ? set_value('renda-total') : $renda_total; ?>"
                               placeholder="Valor em R$">
                ...
                <div class="row">
                    <div class="col s12 m12 l4 input-field">
                        ...
                        <select name="programas-governo[]" size="6" id="programas-governo" multiple>
                            <option value="1" <?php if( ! isset($method) && ($nenhum_programa === '1')): ?> <?php echo e('selected'); ?> <?php endif; ?>>Nenhum</option>
                            <option value="2" <?php if( ! isset($method) && ($bolsa_familia === '1')): ?> <?php echo e('selected'); ?> <?php endif; ?>>Bolsa Família</option>
                            <option value="3" <?php if( ! isset($method) && ($bpc === '1')): ?> <?php echo e('selected'); ?> <?php endif; ?>>BPC</option>
                            <option value="4" <?php if( ! isset($method) && ($aposentadoria === '1')): ?> <?php echo e('selected'); ?> <?php endif; ?>>Aposentadoria</option>
                            <option value="5" <?php if( ! isset($method) && ($pensao === '1')): ?> <?php echo e('selected'); ?> <?php endif; ?>>Pensão</option>
                            <option value="6" <?php if( ! isset($method) && ($beneficio_eventual === '1')): ?> <?php echo e('selected'); ?> <?php endif; ?>>Benefício eventual</option>
                        </select>
            ...
            <div class="card-action">
                <div class="center">
                    <button type="submit" class="btn waves-effect waves-light green darken-4">
                        <?php echo isset($method) ? 'Salvar' : 'Atualizar'; ?>
