...
<aside>
    <ul id="slide-out" class="sidenav sidenav-fixed indigo darken-4">
        ...
        <div class="sidenav-menu-padding">
            ...
            <li><a href="#" class="dropdown-trigger" data-target="menu-perfil">
                    <i class="material-icons white-text small valign-wrapper">account_circle</i></a></li>
        </div>
    </ul>
...
<ul id="menu-perfil" class="dropdown-content">
    <li><a href="#!"><?php echo e($_SESSION['nome-usuario']); ?></a></li>
    <li class="divider"></li>
    <li><a href="#!"><span class="light">PERFIL</span></a></li>
    <li><a href="#!"><span class="light">
    <?php 
    ...
    <li class="divider"></li>
    <li><a href="<?php echo e(base_url('logout')); ?>">Sair</a></li>
</ul>
