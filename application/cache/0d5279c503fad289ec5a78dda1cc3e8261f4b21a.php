    ...
    <div class="col s12 m12 l4 offset-l4">
        <div class="row">
            <div class="col s12 m12 l12 center">
                <img src="<?php echo e(base_url('resources/svg/awujo.logo.simple.svg')); ?>" alt="" class="responsive-img" style="height: 10vh">
            ...
            <div class="row">
                <div class="input-field col s12 m12 l12">
                    ...
                    <input type="password" name="confirmar-passwd" id="confirmar-passwd"
                           class="validate <?php if(form_error('confirmar-passwd')): ?> <?php echo e('invalid'); ?> <?php endif; ?>"
                           value="<?php echo e(set_value('confirmar-passwd')); ?>">
                    <label for="confirmar-passwd">Redigite a senha</label>
                    <span class="helper-text" data-error="<?php echo form_error('confirmar-passwd'); ?>"></span>
                </div>
            </div>
